//
/*
  Based on the above exercise, show a timeline for each month of the course.
  Create a list in which public holidays and a description will be recorded. For example, 1
  May, Labour Day.
  These holidays should have a different style.
