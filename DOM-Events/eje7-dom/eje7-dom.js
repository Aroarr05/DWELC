// Función para crear la tabla con las propiedades dadas y estilos alternos
function crearTabla() {
    ...
    for (let i = 0; i < filas; i++) {
        ...
        for (let j = 0; j < columnas; j++) {
            ...
            // Aplicar clase de estilo alterno: columnas pares e impares
            if ((j + 1) % 2 === 0) {
                celda.classList.add('columna-par');  // Estilo para columnas pares
            } else {
                celda.classList.add('columna-impar');  // Estilo para columnas impares
            }
